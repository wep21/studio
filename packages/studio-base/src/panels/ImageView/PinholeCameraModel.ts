...
export default class PinholeCameraModel {
  ...
  constructor(info: CameraInfo) {
    ...
    this.D = D8 as Vec8;
    this.K = K.length === 9 ? (K as Mat3) : mat3Identity();
    this.P = P.length === 12 ? (P as Mat34) : mat34Identity();
    this.R = R.length === 9 ? (R as Mat3) : mat3Identity();
