...
export type CameraInfoSettings = {
  distance?: number;
};

export default function CameraInfoEditor(
  _props: TopicSettingsEditorProps<CameraInfo, CameraInfoSettings>,
): JSX.Element {
  ...
  return (
    <Flex col>
      ...
      {/* FIXME: description and numeric input */}
    </Flex>
  );
}
